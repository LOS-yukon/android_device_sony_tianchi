...
PRODUCT_COPY_FILES := \
    ...
    device/sony/tianchi/rootdir/system/vendor/etc/mixer_paths.xml:system/vendor/etc/mixer_paths.xml \
...
# Sensors
PRODUCT_COPY_FILES += \
    device/sony/tianchi/rootdir/system/etc/_hals.conf:system/vendor/etc/sensors/_hals.conf
